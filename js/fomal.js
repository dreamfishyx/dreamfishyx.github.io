...
function createtime1() {
  var grt = new Date("08/08/2022 00:00:00"); //此处修改你的建站时间或者网站上线时间
...
function createtime2() {
  ...
  setTimeout(
    console.warn.bind(
      console,
      "%c ⚡ Powered by Dreamfish %c 你正在访问Dreamfishの小家",
...
function createtime() {
  ...
  // 网站诞生时间
  var grt = new Date("08/08/2022 00:00:00");
  ...
  (currentTimeHtml =
    hnum < 18 && hnum >= 9
      ? `<span style="font-size:13px;font-weight:bold">梦鱼今天要努力实现梦想鸭~</span><br> <div style="font-size:13px;font-weight:bold">梦之海居然已经存在了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`
      : `<span style="font-size:13px;font-weight:bold">梦鱼明天也要努力冲鸭~</span><br> <div style="font-size:13px;font-weight:bold">梦之海居然已经存在了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`),
  ...
  setTimeout(function () {
    new Vue({
      data: function () {
        this.$notify({
          title: "提示🍒",
          message: " (｡･∀･)ﾉﾞ欢迎来到Dreamfish的梦之海，祝您旅途愉快！",
          position: 'top-left',
          offset: 50,
          showClose: true,
          type: "success",
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(https://cdn.jsdelivr.net/gh/dreamfishyx/pictures@main/img/2023-03-25-18-03-32-88c80a.webp);
    --darkmode-bg:url(https://cdn.jsdelivr.net/gh/dreamfishyx/pictures@main/img/2023-03-25-17-02-34-ef9639.jpg);
    --mobileday-bg: url(https://cdn.jsdelivr.net/gh/dreamfishyx/pictures@main/img/2023-03-26-14-03-55-d7f3b8.jpg);
    --mobilenight-bg: url(https://cdn.jsdelivr.net/gh/dreamfishyx/pictures@main/img/2023-03-26-14-04-01-990899.jpg);
  }`;
}
// 手机壁纸:https://cdn.jsdelivr.net/gh/dreamfishyx/pictures@main/img/2023-03-26-14-03-06-f478e5.webp https://cdn.jsdelivr.net/gh/dreamfishyx/pictures@main/img/2023-03-26-14-04-14-9cff11.jpg https://cdn.jsdelivr.net/gh/dreamfishyx/pictures@main/img/2023-03-26-14-04-20-73693b.jpg
// 切换背景主函数
function changeBg(s) {
  // 自定义颜色框
